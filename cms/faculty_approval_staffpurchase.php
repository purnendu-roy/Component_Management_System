...
$gname=$row2['name'];
$sql="SELECT distinct uid FROM request_component WHERE utype='Staff' and gname='$gname' and status='pending'";
...
else
{
	...
	while($row = mysql_fetch_array($result))
	{
		...
		{	
			...
			<td><a href='staff_purchase_request_details.php?rno=".$row['uid']."&name=".$row1['name']."'>
