...
<body>
<form action="faculty_approval_studentissue.php" method="POST" onLoad="_top">
<?php
...
$gname=$row2['name'];
$sql="SELECT distinct uid FROM request_issue WHERE utype='Student' and gname='$gname' and status='pending'";
...
{
	echo "<br/><h3 style='color:red' align='center'>Issue Requests</h5>";
	...
	while($row = mysql_fetch_array($result))
	{
		...
		{	
			...
			<td><a href='student_issue_request_details.php?rno=".$row['uid']."&name=".$row1['name']."'>
