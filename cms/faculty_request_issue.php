...
<body>
<form action="faculty_request_issue.php" method="POST" onLoad="_top" name="myForm" id="myForm">
<?php
include 'faculty.php';
if(!isset($_POST['component']))
{
	print "<h3 align='center'>Issue Consumable Items</h3>";
   	addform();
}
...
function searchData()
{
	...
	else
	{
		...
		while($row = mysql_fetch_array($result))
		{
			...
			<td><a href='faculty_confirm_issue.php?id=".$row[0]."&quantity=".$row[5]."'>Issue</a></td></tr>";
			}
			else
			{
