...
<body>
<form action="search_consumable.php" method="POST" onLoad="_top" name="myForm" id="myForm">

<?php

if(!isset($_POST['component']))
{
	print "<br/><h3 align='center' style='color:blue'><b>Search Consumable Items</b> </h3>";
    addform();
}
...
{
	print "<br/><h3 align='center' style='color:red'><b>Search Consumable Items</b> </h3>";
   	addform();
}
?>
<?php
...
function searchData()
{
	...
	{
		echo "<br/><h3 style='color:red' align='center'>Searched Result...</h3>";
		...
		echo "</th><th>Quantity</th><th>Consumed Quantity</th><th>Price(Rs.)</th><th>Purchase Date</th>
		<th>Manufacturer</th><th>Bill No.</th></tr>";
	...
	while($row = mysql_fetch_array($result))
	{
		if(($v%2)==0)
		{	
	  echo "<tr class='alt'><u><td><a href='purchase_history.php?id=".$row[0]."'>".$row[1]."</a></u></td>
	  <td>".$row[2]."</td><td>".$row[3]."</td><td>".$row[4]."</td>";
		...
		echo "<td>".$row[5]."</td><td>".$row[15]."</td>
		<td>".$row[6]."</td><td>".$row[7]."</td><td>".$row[11]."</td><td>".$row[9]."</td></tr>";
		}
		else
		{
echo "<tr><u><td><a href='purchase_history.php?id=".$row[0]."'>".$row[1]."</a></u></td><td>".$row[2]."</td>
	...
	echo "<br><center><button type='button'><a href='edit_consumable.php'>Back</a></button></center></br>";
	}
}
?>
</form>
