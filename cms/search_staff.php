...
<br>
<form action="search_staff.php" method="POST" onLoad="_top">
<?php
...
{
    include 'db.php';
	echo "<b><table align='center'><tr><td>Staff ID:</td><td><input type=text name='id'></input></td></tr>";
	echo "<tr><td>Staff Name:</td><td><input type=text name='name'></input></td></tr>";
...
function searchdata()
{
	...
	$email = $_POST['email'];
	$phone = $_POST['phone'];
	$sql="select * from staff where id like '%$id%' and name like '%$name%' and lab like '%$lic%' and email 
