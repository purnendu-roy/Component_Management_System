...
<body>
<form action="student_purchase_request_details.php" method="POST" onLoad="_top">
<?php
include 'faculty.php';
...
function form($id)
{
	...
	$sql="SELECT * FROM request_component WHERE uid='$id' and utype='Student' and gname='$gname' and
	status='pending'";
	...
	while($row = mysql_fetch_array($result))
	{
		...
		if(($v%2)==0)
		{
			echo "<tr class='alt'><td>".$no."</td><td>".$row[4]."</td><td>".$row[3]."</td><td>".$row[7]."</td>
	...
	echo "</table>";
	echo "<br/><table align='center'><tr><td><input type='submit' name='approve' value='Approve Selected'></input>
