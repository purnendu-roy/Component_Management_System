...
<form action="student_request_issue.php" method="POST" onLoad="_top" name="myForm" id="myForm">
...
function searchData()
{
	...
	while($row = mysql_fetch_array($result))
	{
		...
		{	
			...
			<td><a href='student_confirm_issue.php?id=".$row[0]."&quantity=".$row[5]."'>Issue</a></td></tr>";
		}
		else
		{
		...
		echo "</table><center/>";
		echo "<br><input type=button value='back' onclick=window.location.href='student_request_issue.php'>
		</input>";
