...
<body>
<form action="student_request_issuewithdraw.php" method="POST" onLoad="_top">
<?php
	include 'student.php';
	include 'db.php';
	...
	else
	{
		...
		<th>Guide</th><th>Request Date</th><th>Status</th><th></th></tr>";
		$v=1;
		$no=1;
		...
		{	$id=$row['cid'];
			...
			echo "<td><a href='student_confirm_issuewithdraw.php?id=".$row[0]."'>Withdraw</a></td>";
		}
		else
		{
			$id=$row['cid'];
